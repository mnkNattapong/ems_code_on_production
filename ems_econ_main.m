...
main_cost = 'energyfromgrid';
% main_cost = 'energycost';
% main_cost = 'profit';

other_modules = {'multibatt','chargebatt','smoothcharge'};
module = [{main_cost}, other_modules];
...
start_date   = '2023-04-18 00:00:00';           % Start date (str format: YYYY-MM-DD HH:mm:ss)
...
sol = ems_econ_opt(PARAM,1,solution_path);
